...
Patch0002: 0002-add-last_activity-to-session.patch
...
%changelog
* Fri May 29 2015 Dunrong Huang <dunrong.huang@eayun.com> - 1.1.7-2
- add 0002-add-last_activity-to-session.patch
